      ...
      <footer className="mgm-footer">
         ...
         <div className = "container">
            <div className = "notice">
              ...
              <ul>
                <li>
                  <Link>
                    <span className="text-subject">네임펜 제품가격 인상안내</span>
            ...
            <div className = "customor">
              ...
              <div className="space-between">
                <div>
                  ...
                  <div className="margin-bottom-8">평일08:30~17:30(점심시간 12:00~13:00)</div>
                  <div>주말/공휴일: 휴무</div>
                </div>
                <div>
        ...
        <div className="footer-bottom space-between container">
          ...
          <div className="info">
            <div>
              <ul className="space-between">
                ...
                <li><Link>사업자 정보확인</Link></li>
                <li><Link>제휴/입점 안내</Link></li>
              </ul>
              <div>(주)모나미 | 대표 : 민경민 | 주소 : 서울시 광진구 지구 노로 17 | 사업자등록번호 : 101-22-01004</div>
              <div className="margin-bottom-20">고객센터 : 4451-4882 | 개인정보관리책임자 : 민경민(monawehelp@monami.com) | 통신판매업신고 : 제5001-서울광진-0191</div>
              <div>본 사이트의 모든 저작물의 저작권은 (주)모나위에 있습니다.</div>
              <div className="margin-bottom-20">무단 복제나 도용은 저작권법 제 97조 5항에 의해 법으로 금지되어 있습니다.</div>
          ...
          <div className="family">
            ...
            <div className="margin-bottom-8 strong">이니시스(에스크로) 서비스</div>
            <div>
              고객님은 안전거래를 위해 모든 거래 결제 시 저희 쇼핑몰에서 가입한 전자 결제의 매매보호(에스크로) 서비스를 이용하실 수 있습니다.
            </div>
          </div>
        </div>
      </footer>
